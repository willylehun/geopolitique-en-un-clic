...
IMPACT={
 10:["guerre nucléaire","guerre mondiale","emploi de l’arme nucléaire","attaque nucléaire","invasion générale","coup d’état réussi","renversement du gouvernement","nuclear war","world war","guerre","invasion","frappe aérienne","frappe de missile","attaque militaire","cessez-le-feu","mobilisation militaire","état d’urgence","coup d’état","sanctions internationales","défaut souverain","séisme majeur","missile","airstrike","ceasefire","military attack","sanctions"],
 9:["conflit armé","élection présidentielle","élections législatives","élection nationale","inflation","taux directeur","banque centrale","récession","embargo","sommet international","accord de paix","traité","crise politique","crise diplomatique","crise énergétique","pétrole","gaz","défense","sécurité nationale","tarifs douaniers","droits de douane","conflict","election","interest rate","central bank","recession","summit","embargo","oil","gas"],
 8:["gouvernement","président","premier ministre","parlement","diplomatie","commerce international","budget de l’état","manifestation","frontière","migration","énergie","climat","inondation","incendie","catastrophe naturelle","cyberattaque","intelligence artificielle","technologie stratégique","accord commercial","government","president","prime minister","parliament","diplomacy","trade","energy","protest","border","climate","flood","wildfire","cyberattack"],
 7:["économie","marché","investissement","exportation","importation","santé publique","épidémie","infrastructure","transport maritime","agriculture","justice","economic","market","investment","export","import","health","disease","infrastructure","shipping","agriculture"],
 6:["politique locale","administration","entreprise","société","politics","business","society"]
}
